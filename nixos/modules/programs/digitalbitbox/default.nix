...

{
  options.programs.digitalbitbox = {
    ...
    package = mkPackageOption pkgs "Digital Bitbox" {
      default = [ "digitalbitbox" ];
      extraDescription = "This can be used to install a package with udev rules that differ from the defaults.";
    };
  };
